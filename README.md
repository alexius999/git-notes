...
Перейти на страницу официального сайта Git.
...
ls -a | отобразить также скрытые файлы и папки, названия которых начинаются с символа . |
cd first-project | сменить директорию, т.е. перейди в папку first-project | change directory
...
mkdir second-project | создать директорию/папку с именем second-project в текущей папке | make directory

### Копирование и перемещение

cp file.txt ~/my-dir | копировать файл в другое место | copy
mv file.txt ~/my-dir | перемести файл или папку в другое место | move

### Чтение

cat file.txt | объединить и распечатать содержимое текстового файла file.txt | concatenate and print

### Удаление

rm about.html | удалить файл about.html | remove
rmdir images  | удалить директорию/папку images | remove directory
rm -r second-project | удалить папку second-project и всё, что она содержит | remove
...
SHA256:u+jW2SUszanEX/1BdH0cr0PDOQYSfCZ3F0CMW2+D6dM alexey.kosikov@gmail.com
